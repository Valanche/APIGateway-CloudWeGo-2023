...
func (p *AddServiceReq) GetFileName() (v string) {
	return p.FileName
}

func (p *AddServiceReq) GetFileContent() (v []byte) {
...
func (p *AddServiceReq) ReadField3(iprot thrift.TProtocol) error {
...
func (p *AddServiceReq) writeField3(oprot thrift.TProtocol) (err error) {
...
type ChangeServiceReq struct {
	Name        string `thrift:"Name,1" form:"svcname" json:"svcname"`
	FileContent []byte `thrift:"FileContent,2" form:"idlfile" json:"idlfile"`
}
...
type IDLManageService interface {
	...
	GetIDL(ctx context.Context, request *GetServiceReq) (r *ManageServiceResp, err error)

	ListIDL(ctx context.Context) (r *ManageServiceResp, err error)
}
...
func (p *IDLManageServiceClient) GetIDL(ctx context.Context, request *GetServiceReq) (r *ManageServiceResp, err error) {
	var _args IDLManageServiceGetIDLArgs
	_args.Request = request
	var _result IDLManageServiceGetIDLResult
	if err = p.Client_().Call(ctx, "GetIDL", &_args, &_result); err != nil {
		return
	}
	return _result.GetSuccess(), nil
}
func (p *IDLManageServiceClient) ListIDL(ctx context.Context) (r *ManageServiceResp, err error) {
	var _args IDLManageServiceListIDLArgs
	var _result IDLManageServiceListIDLResult
...
func NewIDLManageServiceProcessor(handler IDLManageService) *IDLManageServiceProcessor {
	...
	self.AddToProcessorMap("GetIDL", &iDLManageServiceProcessorGetIDL{handler: handler})
	self.AddToProcessorMap("ListIDL", &iDLManageServiceProcessorListIDL{handler: handler})
	return self
}
...
type iDLManageServiceProcessorGetIDL struct {
	handler IDLManageService
}

func (p *iDLManageServiceProcessorGetIDL) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
	args := IDLManageServiceGetIDLArgs{}
	if err = args.Read(iprot); err != nil {
		iprot.ReadMessageEnd()
		x := thrift.NewTApplicationException(thrift.PROTOCOL_ERROR, err.Error())
		oprot.WriteMessageBegin("GetIDL", thrift.EXCEPTION, seqId)
		x.Write(oprot)
		oprot.WriteMessageEnd()
		oprot.Flush(ctx)
		return false, err
	...
	iprot.ReadMessageEnd()
	var err2 error
	result := IDLManageServiceGetIDLResult{}
	var retval *ManageServiceResp
	if retval, err2 = p.handler.GetIDL(ctx, args.Request); err2 != nil {
		x := thrift.NewTApplicationException(thrift.INTERNAL_ERROR, "Internal error processing GetIDL: "+err2.Error())
		oprot.WriteMessageBegin("GetIDL", thrift.EXCEPTION, seqId)
		x.Write(oprot)
		oprot.WriteMessageEnd()
		oprot.Flush(ctx)
	...
	if err2 = oprot.WriteMessageBegin("GetIDL", thrift.REPLY, seqId); err2 != nil {
		err = err2
	}
	if err2 = result.Write(oprot); err == nil && err2 != nil {
		err = err2
...
type iDLManageServiceProcessorListIDL struct {
	handler IDLManageService
}

func (p *iDLManageServiceProcessorListIDL) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
	args := IDLManageServiceListIDLArgs{}
	if err = args.Read(iprot); err != nil {
		iprot.ReadMessageEnd()
		x := thrift.NewTApplicationException(thrift.PROTOCOL_ERROR, err.Error())
	...
	iprot.ReadMessageEnd()
	var err2 error
	result := IDLManageServiceListIDLResult{}
	var retval *ManageServiceResp
	if retval, err2 = p.handler.ListIDL(ctx); err2 != nil {
...
type IDLManageServiceGetIDLArgs struct {
	Request *GetServiceReq `thrift:"request,1"`
}

func NewIDLManageServiceGetIDLArgs() *IDLManageServiceGetIDLArgs {
	return &IDLManageServiceGetIDLArgs{}
}

var IDLManageServiceGetIDLArgs_Request_DEFAULT *GetServiceReq

func (p *IDLManageServiceGetIDLArgs) GetRequest() (v *GetServiceReq) {
	if !p.IsSetRequest() {
		return IDLManageServiceGetIDLArgs_Request_DEFAULT
	}
	return p.Request
}

var fieldIDToName_IDLManageServiceGetIDLArgs = map[int16]string{
	1: "request",
}

func (p *IDLManageServiceGetIDLArgs) IsSetRequest() bool {
	return p.Request != nil
}

func (p *IDLManageServiceGetIDLArgs) Read(iprot thrift.TProtocol) (err error) {
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_IDLManageServiceGetIDLArgs[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
...
func (p *IDLManageServiceGetIDLArgs) ReadField1(iprot thrift.TProtocol) error {
...
func (p *IDLManageServiceGetIDLArgs) Write(oprot thrift.TProtocol) (err error) {
	var fieldId int16
	if err = oprot.WriteStructBegin("GetIDL_args"); err != nil {
		goto WriteStructBeginError
	}
	if p != nil {
		if err = p.writeField1(oprot); err != nil {
...
func (p *IDLManageServiceGetIDLArgs) writeField1(oprot thrift.TProtocol) (err error) {
	if err = oprot.WriteFieldBegin("request", thrift.STRUCT, 1); err != nil {
		goto WriteFieldBeginError
	}
	if err := p.Request.Write(oprot); err != nil {
...
func (p *IDLManageServiceGetIDLArgs) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("IDLManageServiceGetIDLArgs(%+v)", *p)
}

type IDLManageServiceGetIDLResult struct {
	Success *ManageServiceResp `thrift:"success,0,optional"`
}

func NewIDLManageServiceGetIDLResult() *IDLManageServiceGetIDLResult {
	return &IDLManageServiceGetIDLResult{}
}

var IDLManageServiceGetIDLResult_Success_DEFAULT *ManageServiceResp

func (p *IDLManageServiceGetIDLResult) GetSuccess() (v *ManageServiceResp) {
	if !p.IsSetSuccess() {
		return IDLManageServiceGetIDLResult_Success_DEFAULT
	}
	return p.Success
}

var fieldIDToName_IDLManageServiceGetIDLResult = map[int16]string{
	0: "success",
}

func (p *IDLManageServiceGetIDLResult) IsSetSuccess() bool {
	return p.Success != nil
}

func (p *IDLManageServiceGetIDLResult) Read(iprot thrift.TProtocol) (err error) {
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_IDLManageServiceGetIDLResult[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
...
func (p *IDLManageServiceGetIDLResult) ReadField0(iprot thrift.TProtocol) error {
	p.Success = NewManageServiceResp()
	if err := p.Success.Read(iprot); err != nil {
		return err
	}
...
func (p *IDLManageServiceGetIDLResult) Write(oprot thrift.TProtocol) (err error) {
	var fieldId int16
	if err = oprot.WriteStructBegin("GetIDL_result"); err != nil {
		goto WriteStructBeginError
	}
	if p != nil {
		if err = p.writeField0(oprot); err != nil {
...
func (p *IDLManageServiceGetIDLResult) writeField0(oprot thrift.TProtocol) (err error) {
	if p.IsSetSuccess() {
		if err = oprot.WriteFieldBegin("success", thrift.STRUCT, 0); err != nil {
			goto WriteFieldBeginError
		}
...
func (p *IDLManageServiceGetIDLResult) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("IDLManageServiceGetIDLResult(%+v)", *p)
}

type IDLManageServiceListIDLArgs struct {
}

func NewIDLManageServiceListIDLArgs() *IDLManageServiceListIDLArgs {
	return &IDLManageServiceListIDLArgs{}
}

var fieldIDToName_IDLManageServiceListIDLArgs = map[int16]string{}

func (p *IDLManageServiceListIDLArgs) Read(iprot thrift.TProtocol) (err error) {
...
func (p *IDLManageServiceListIDLArgs) Write(oprot thrift.TProtocol) (err error) {
...
func (p *IDLManageServiceListIDLArgs) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("IDLManageServiceListIDLArgs(%+v)", *p)
}

type IDLManageServiceListIDLResult struct {
	Success *ManageServiceResp `thrift:"success,0,optional"`
}

func NewIDLManageServiceListIDLResult() *IDLManageServiceListIDLResult {
	return &IDLManageServiceListIDLResult{}
}

var IDLManageServiceListIDLResult_Success_DEFAULT *ManageServiceResp

func (p *IDLManageServiceListIDLResult) GetSuccess() (v *ManageServiceResp) {
	if !p.IsSetSuccess() {
		return IDLManageServiceListIDLResult_Success_DEFAULT
	}
	return p.Success
}

var fieldIDToName_IDLManageServiceListIDLResult = map[int16]string{
	0: "success",
}

func (p *IDLManageServiceListIDLResult) IsSetSuccess() bool {
	return p.Success != nil
}

func (p *IDLManageServiceListIDLResult) Read(iprot thrift.TProtocol) (err error) {
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_IDLManageServiceListIDLResult[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
...
func (p *IDLManageServiceListIDLResult) ReadField0(iprot thrift.TProtocol) error {
	p.Success = NewManageServiceResp()
	if err := p.Success.Read(iprot); err != nil {
		return err
	}
...
func (p *IDLManageServiceListIDLResult) Write(oprot thrift.TProtocol) (err error) {
	var fieldId int16
...
func (p *IDLManageServiceListIDLResult) writeField0(oprot thrift.TProtocol) (err error) {
	if p.IsSetSuccess() {
		if err = oprot.WriteFieldBegin("success", thrift.STRUCT, 0); err != nil {
			goto WriteFieldBeginError
		}
...
func (p *IDLManageServiceListIDLResult) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("IDLManageServiceListIDLResult(%+v)", *p)
}
